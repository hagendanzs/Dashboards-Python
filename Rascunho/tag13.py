...
class MonitorCLPApp:
    ...
    def zerar_contadores(self):
        ...
        try:
            # Desabilita o botão momentaneamente para evitar cliques repetidos
            ...
            # Verifica se os dois comandos de escrita retornaram sucesso
            if res0.Status == "Success" and res1.Status == "Success":
                self.lbl_ip.config(text=f"CLP IP: {IP_CLP} - CONTADORES ZERADOS OK!", fg="#00ff66")
                # Limpa o histórico laranja do gráfico local para resetar a tendência visual imediatamente
