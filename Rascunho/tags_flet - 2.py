...
def main(page: ft.Page):
    ...
    try:
        fonte_arquivo_path = os.path.join(os.path.dirname(__file__), ARQUIVO_FONTE)
        if os.path.exists(fonte_arquivo_path):
            page.fonts = {"LCD_Custom": fonte_arquivo_path}
            fonte_relogio = "LCD_Custom"
            print(f"Fonte personalizada '{fonte_arquivo_path}' carregada.")
        else:
            print(f"Aviso: Arquivo de fonte '{fonte_arquivo_path}' não encontrado. Usando Consolas.")
