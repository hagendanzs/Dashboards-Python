...
def main(page: ft.Page):
    ...
    try:
        if os.path.exists(ARQUIVO_FONTE):
            ...
            print(f"Fonte personalizada '{ARQUIVO_FONTE}' carregada.")
        else:
            print(f"Aviso: Arquivo de fonte '{ARQUIVO_FONTE}' não encontrado. Usando Consolas.")
    ...
    lista_tags = ['Conta[0].acc', 'Conta[1].acc'] + [f'Reais[{i}]' for i in range(6)]
    widgets_dados = {}
